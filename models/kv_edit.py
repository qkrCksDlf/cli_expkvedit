...
class Flux_kv_edit(only_Flux):
    ...
    def denoise(self, z0, z0_r, zt_r, inp_target, mask:Tensor, opts, info, info_s, union_mask:Tensor, inp_target_s): #모두 레퍼런스로 넣어줌. info는 소스, z0도 소스. 
        '''
        ...
        info['inverse'] = False
        x, _ = denoise_kv(self.model, **inp_target, timesteps=denoise_timesteps, guidance=opts.denoise_guidance, inverse=False, info=info, info_s=info_s, zt_r=zt_r,inp_target_s=inp_target_s)
